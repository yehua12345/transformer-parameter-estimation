...
class ResNet(nn.Module):
    ...
    def __init__(self, block, block_num, num_classes=1000):
        ...
        self.mlp_head1 = nn.Linear(512 * block.expansion, 12)
        self.mlp_head2 = nn.Linear(512 * block.expansion, 21)
        self.mlp_head3 = nn.Linear(512 * block.expansion, 10)
        self.mlp_head4 = nn.Linear(512 * block.expansion, 5)
...
if __name__ == '__main__':
    # 10分类
    res18 = resnet50(10).to('cuda:0')
    input1 = torch.randn(1, 1, 512, 2).cuda()
    flops, para = profile(res18, inputs=(input1,))
    print(flops, para)
