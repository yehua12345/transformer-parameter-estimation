...
#     def __init__(self, d_in, d_hid, dropout=0.1):
#         super().__init__()
#         self.w_1 = nn.Conv2d(1, 1, 3,padding=1)
...
class ViT(nn.Module):
    def __init__(self, *,dim=256, depth=6, heads=8, mlp_dim=256,dim_head = 64, dropout = 0.6):
        super().__init__()
        self.to_patch_embedding1 = nn.Sequential(
            nn.Conv2d(1, 32, kernel_size=(3, 2), stride=(1, 2), padding=(1, 0)),
            nn.BatchNorm2d(32),
            nn.ReLU(),
            ...
            nn.ReLU(),
            nn.MaxPool2d((2, 1), (2, 1)),
            nn.Conv2d(64, 256, kernel_size=(3, 1), padding=(1, 0)),
            nn.BatchNorm2d(256),
            nn.ReLU(),
            nn.MaxPool2d((2, 1), (2, 1)),
