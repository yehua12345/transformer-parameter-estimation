...
class ShuffleNet(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes=100, groups=3):
        ...
        self.mlp_head1 = nn.Linear(out_channels[3], 12)
        self.mlp_head2 = nn.Linear(out_channels[3], 21)
        self.mlp_head3 = nn.Linear(out_channels[3], 10)
        self.mlp_head4 = nn.Linear(out_channels[3], 5)
